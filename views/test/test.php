    ...
    <section class="container pt-5">
        <div class="shadow p-3 mb-5 bg-white rounded">
            ...
            <?php if ($activo[0]['activo'] == 1) { ?>
                ...
                <div class="pt-4 pb-4">
                    <div class="card">
                        <h5 class="card-header text-center">PRUEBAS DISPONIBLES</h5>
                        <div class="card-body">
                            <p class="text-center">De clic sobre la prueba que desea realizar.</p>
                        </div>
                        <?php
                        $costo = new Pruebas();
                                ...
                                <div class="d-flex text-center justify-content-center">
                                    <form action="" method="post">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Por favor indique la cantidad que pago por la prueba</label>
                                            <input type="number" name="costo" class="form-control" required>
                                        </div>
                                        <input type="submit" class="btn btn-outline-green btn-block">
                                    </form>
                                </div>
                            </div>
                        <?php
