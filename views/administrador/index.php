                ...
                switch ($m) {
                    case '1':
                        ...
                        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <strong>¡AVISO!</strong>&nbsp;El personal a sido agregado exitosamente
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select name="cmbInstitucion" id="cmbInstitucion" class="selectpicker form-control" data-live-search="true" required>
                                    ...
                                    <?php foreach ($rowInstitucion as $item) : ?>
                                        <option value="<?php echo $item['id_institucion']; ?>" <?php if ($item['id_institucion'] == @$institution) echo "selected"; ?>>
                ...
                <div class="form-row">
                    <div class="form-group col-sm-12">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="txtNombre" placeholder="Nombre(s)" class="form-control" onkeyup="conMayusculas(this);" onkeypress="return soloLetras(event);" value="<?php echo @$_POST["txtNombre"]; ?>" required>
                            <div class="invalid-feedback">
